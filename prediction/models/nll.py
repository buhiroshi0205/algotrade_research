import torch
from torch.nn import Module, Linear, GRU, Softmax, ReLU, Tanh, Dropout, BatchNorm1d, ModuleList, MSELoss, init, GaussianNLLLoss
...
class DailyModel(Module):
    def __init__(self, dim_0, dim_1=256, dim_2=512, dropout=0.1, gru_layers=1) -> None:
        ...
        self.linear_out = Linear(dim_2, 2)
...
class NLL(Module):
    ...
    def forward(self, pred, y):
        mean = pred[:,0]
        std = pred[:,1]
        return self.nll(mean, y, torch.square(std))
